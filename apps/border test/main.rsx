<App>
  ...
  >
    ...
    >
      <Header>
        <Tabs
          ...
          value="{{ self.values[0] }}"
        >
          <Option id="5bc4e" value="Tab 1" />
          <Option id="e1c05" value="Tab 2" />
          <Option id="53649" value="Tab 3" />
        </Tabs>
        <Module
          id="testVersions1"
          name="test versions"
          pageUuid="0f3b4c18-8030-11ef-97b6-3b1d7ea437cd"
        />
      </Header>
      <View id="6d320" viewKey="View 1" />
      <View id="65481" viewKey="View 2" />
      <View id="b40a4" viewKey="View 3" />
    </Container>
    <ListViewBeta
      id="listView1"
      data={
    ...
    >
      <Option id="a9de2" value="Option 1" />
      <Option id="9e90e" value="Option 2" />
      <Option id="45838" value="Option 3" />
    </Select>
    <Table
      id="table1"
      cellSelection="none"
    ...
    >
      <Header>
        <Tabs
          ...
          value="{{ self.values[0] }}"
        >
          <Option id="78366" value="Tab 1" />
          <Option id="8f591" value="Tab 2" />
          <Option id="21074" value="Tab 3" />
        </Tabs>
      </Header>
      <View id="a0b64" viewKey="View 1" />
      <View id="eb65a" viewKey="View 2" />
      <View id="91184" viewKey="View 3" />
    </Container>
    <Text
      id="text1"
    ...
    <Module
      id="tableBorderTest2"
      margin="0"
      name="table border test"
      pageUuid="7659c154-7825-11ee-84a4-d30122725611"
    />
  </Frame>
</App>
